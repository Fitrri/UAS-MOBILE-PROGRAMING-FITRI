...
extension ArticleModelByIndex on IsarCollection<ArticleModel> {
  Future<ArticleModel?> getByUrl(String? url) {
    return getByIndex(r'url', [url]);
  }

  ArticleModel? getByUrlSync(String? url) {
  ...
  Future<List<ArticleModel?>> getAllByUrl(List<String?> urlValues) {
    final values = urlValues.map((e) => [e]).toList();
    return getAllByIndex(r'url', values);
  }

  List<ArticleModel?> getAllByUrlSync(List<String?> urlValues) {
    final values = urlValues.map((e) => [e]).toList();
  ...
  Future<Id> putByUrl(ArticleModel object) {
    return putByIndex(r'url', object);
  }

  Id putByUrlSync(ArticleModel object, {bool saveLinks = true}) {
    return putByIndexSync(r'url', object, saveLinks: saveLinks);
  }

  Future<List<Id>> putAllByUrl(List<ArticleModel> objects) {
    return putAllByIndex(r'url', objects);
  }

  List<Id> putAllByUrlSync(List<ArticleModel> objects,
      {bool saveLinks = true}) {
...
extension ArticleModelQueryWhere
  ...
  QueryBuilder<ArticleModel, ArticleModel, QAfterWhereClause> urlIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ArticleModel, ArticleModel, QAfterWhereClause> urlIsNotNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ArticleModel, ArticleModel, QAfterWhereClause> urlEqualTo(
      String? url) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'url',
  ...
  QueryBuilder<ArticleModel, ArticleModel, QAfterWhereClause> urlNotEqualTo(
      String? url) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
...
extension ArticleModelQueryFilter
  ...
  QueryBuilder<ArticleModel, ArticleModel, QAfterFilterCondition> urlIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'url',
      ));
...
extension ArticleModelQueryWhereDistinct
  ...
  QueryBuilder<ArticleModel, ArticleModel, QDistinct> distinctByAuthor(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension ArticleModelQueryProperty
  ...
  QueryBuilder<ArticleModel, String?, QQueryOperations> authorProperty() {
    return QueryBuilder.apply(this, (query) {
